...
import (
	...
	"github.com/GoAsyncFunc/server-skeleton/internal/app/server"
	"github.com/GoAsyncFunc/server-skeleton/internal/pkg/service"
	...
	app := &cli.App{
		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{
				...
				Value:       "/var/lib/skeleton-node",
				DefaultText: "/var/lib/skeleton-node",
				Required:    false,
				Destination: &dataDir,
			},
			&cli.StringFlag{
